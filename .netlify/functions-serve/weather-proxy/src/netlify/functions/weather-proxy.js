...
var require_form_data = __commonJS({
  'node_modules/form-data/lib/form_data.js'(exports, module2) {
    ...
    FormData3.prototype._generateBoundary = function () {
      this._boundary =
        '--------------------------' + crypto2.randomBytes(12).toString('hex');
    };
  ...
  'node_modules/debug/src/node.js'(exports, module2) {
    ...
    function log(...args) {
      return process.stderr.write(
        util3.formatWithOptions(exports.inspectOpts, ...args) + '\n'
      );
    }
    function save(namespaces) {
      if (namespaces) {
...
// netlify/functions/weather-proxy.ts
var weather_proxy_exports = {};
__export(weather_proxy_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(weather_proxy_exports);
...
var platform_default = __spreadValues(
  __spreadValues({}, utils_exports),
  node_default
);
...
var textEncoder =
  typeof TextEncoder === 'function'
    ? new TextEncoder()
    : new import_util.default.TextEncoder();
var CRLF = '\r\n';
...
var headersToObject = (thing) =>
  thing instanceof AxiosHeaders_default ? __spreadValues({}, thing) : thing;
...
var { ReadableStream: ReadableStream2, TextEncoder: TextEncoder2 } =
  utils_default.global;
var test = (fn, ...args) => {
  try {
    return !!fn(...args);
...
var GEO_API_URL = isLocal
  ? 'http://localhost:8888/.netlify/functions/geo-proxy'
  : import_meta.env.VITE_GEO_API_URL;
var geoApiOptions = {
  method: 'GET',
  headers: {
    'X-RapidAPI-Key': import_meta.env.VITE_GEO_API_KEY,
    'X-RapidAPI-Host': 'wft-geo-db.p.rapidapi.com'
  }
};
var METEOMATICS_URL = isLocal
  ? 'http://localhost:8888/.netlify/functions/weather-proxy'
  : import_meta.env.VITE_METEOMATICS_URL;
var meteomaticsAuth = {
  username: import_meta.env.VITE_METEOMATICS_USER,
  password: import_meta.env.VITE_METEOMATICS_PASS
};

// netlify/functions/weather-proxy.ts
var handler = async (event) => {
  var _a, _b;
  const lat = (_a = event.queryStringParameters) == null ? void 0 : _a.lat;
  const lon = (_b = event.queryStringParameters) == null ? void 0 : _b.lon;
  if (!lat || !lon) {
  ...
  try {
    ...
    const [currentRes, forecastRes] = await Promise.all([
      axios_default.get(currentUrl, {
        auth: { username: user, password: pass }
      }),
      axios_default.get(forecastUrl, {
        auth: { username: user, password: pass }
      })
    ]);
    return {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=weather-proxy.js.map
